...
import { Mail, Lock, LogIn, ArrowRight, User as UserIcon } from 'lucide-react';
    ...
    <div className="min-h-screen bg-dark flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <motion.div 
          ...
          className="absolute -bottom-[10%] -right-[10%] w-[40%] h-[40%] bg-orange-600/10 blur-[120px] rounded-full" 
        />
      </div>
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 text-sm font-bold uppercase tracking-[0.3em]">Neural Interface Access</p>
        </div>

        {/* glass Card */}
        <div className="glass-morphism p-8 border-white/5">
          <h2 className="text-2xl font-black text-white mb-2">Initialize Session</h2>
          <p className="text-slate-500 text-sm mb-8 font-medium">Authentication required for history synchronization.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="group">
              <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mb-2 group-focus-within:text-accent transition-colors">Email Address</label>
            ...
            <div className="group">
              <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mb-2 group-focus-within:text-accent transition-colors">Security Key</label>
              <div className="relative">
          ...
          <div className="mt-8 pt-8 border-t border-white/5 flex flex-col items-center gap-4">
            <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">
              New identity?{' '}
              <Link to="/signup" className="text-accent hover:text-orange-400 transition-colors">
                Register Here
              </Link>
            </p>
          </div>
