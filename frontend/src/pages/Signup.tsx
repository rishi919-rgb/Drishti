  ...
  return (
    <div className="min-h-screen bg-[#0a0a12] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        {/* Card */}
        <div className="p-1 rounded-[2rem] bg-gradient-to-br from-purple-500/20 via-slate-800/50 to-indigo-500/20">
          <div className="bg-[#11111a]/95 backdrop-blur-2xl rounded-[1.9rem] p-8">
            ...
            <p className="text-slate-500 text-sm mb-8">Save your scan history and access personalized features.</p>
